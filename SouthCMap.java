...
public class SouthCMap extends AppCompatActivity {
    public static boolean houseSelected = false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_south_c_map);

        TextView first = (TextView) findViewById(R.id.textView26);
        TextView second = (TextView) findViewById(R.id.textView23);
        TextView third = (TextView) findViewById(R.id.textView19);
        TextView fourth = (TextView) findViewById(R.id.textView25);
