...
public class ContraDms extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contra_dms);
        TextView texttosend = (TextView) findViewById(R.id.message_body13);
    ...
    public void sendText(View view) {
        EditText typefield = (EditText) findViewById(R.id.condSendMsgs2);
        TextView texttosend = (TextView) findViewById(R.id.message_body13);
